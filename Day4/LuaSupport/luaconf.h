...
#ifndef DLLAPI
#if WIN32
#ifdef AIENGINEINTERFACE_EXPORTS
#define DLLAPI __declspec(dllexport)
#else
#define DLLAPI __declspec(dllimport)
#endif
#else
// linux shared libraries has no hidden functions (or if this is not a dll)
#define DLLAPI
#endif
#endif
#define LUA_API DLLAPI
*/
...
#elif CONSOLE || XBOX || PS3

#define lua_popen(L,c,m)	((void)((void)c, m),  \
	luaL_error(L, LUA_QL("popen") " not supported on consoles"), (FILE*)0)
